...
keys = {'SMART_VERT': [{'label': 'Merge Last', 'keymap': 'Mesh', 'idname': 'machin3.smart_vert', 'type': 'ONE', 'value': 'PRESS', 'properties': [('mode', 'MERGE'), ('mergetype', 'LAST'), ('slideoverride', False)]},
        ...
        'SHADING_PIE': [{'keymap': '3D View Generic', 'space_type': 'VIEW_3D', 'idname': 'machin3.call_machin3tools_pie', 'type': 'PAGE_DOWN', 'value': 'PRESS', 'properties': [('idname', 'shading_pie')]}],
        'VIEWS_PIE': [{'keymap': '3D View Generic', 'space_type': 'VIEW_3D', 'idname': 'wm.call_menu_pie', 'type': 'PAGE_UP', 'value': 'PRESS', 'properties': [('name', 'MACHIN3_MT_viewport_pie')]}],
