...
classes = {'CORE': [('ui.UILists', [('AppendMatsUIList', '')]),
           ...
           'SNAP_PIE': [('ui.pies', [('PieSnap', 'snap_pie')]),
                        ('ui.operators.snap_preset', [('SetSnapPreset', 'set_snap_preset')])],
...
keys = {'SMART_VERT': [{'label': 'Merge Last', 'keymap': 'Mesh', 'idname': 'machin3.smart_vert', 'type': 'ONE', 'value': 'PRESS', 'properties': [('mode', 'MERGE'), ('mergetype', 'LAST'), ('slideoverride', False)]},
        ...
        'SNAP_PIE': [{'keymap': '3D View Generic', 'space_type': 'VIEW_3D', 'idname': 'wm.call_menu_pie', 'type': 'BUTTON5MOUSE', 'value': 'PRESS', 'shift': True, 'properties': [('name', 'MACHIN3_MT_snap_pie')]}],
